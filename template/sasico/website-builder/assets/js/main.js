    ...
    init: function () {
      ...
      if (document.querySelector(".project")) {
        new Swiper(".project", {
          ...
          spaceBetween: 20,
          breakpoints: {
            1920: { slidesPerView: 3.9, spaceBetween: 30 },
            1440: { slidesPerView: 3.4, spaceBetween: 30 },
            1366: { slidesPerView: 3.4, spaceBetween: 30 },
            1201: { slidesPerView: 3.1, spaceBetween: 30 },
            1025: { slidesPerView: 2, centeredSlides: false, spaceBetween: 30 },
      ...
      if (document.querySelector(".testi")) {
        ...
        var paginationContainer = document.querySelector(".custom-dots");
        ...
        var dots = document.querySelectorAll(".custom-dot");
        ...
        testiSwiper.on("slideChange", function () {
          var slideNumber = testiSwiper.realIndex + 1;
          var activeIndex = (slideNumber - 1) % totalDots;
